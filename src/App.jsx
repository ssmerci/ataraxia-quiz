...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Trust your instincts, sensing the beast’s natura aether.", value: "N" },
    ],
    dimension: "SN",
  },
  {
    ...
    options: [
      { text: "Evaluate the scroll’s importance logically, prioritizing knowledge.", value: "T" },
  ...
  },
  {
    ...
    options: [
      { text: "Follow a prepared plan, taking shelter systematically.", value: "J" },
  ...
  {
    id: 17,
    text: "On the Niji Archipelagoes’ Mirage Islands, you meet a mysterious figure. How do you engage?",
    options: [
      { text: "Approach them eagerly, curious about their story.", value: "E" },
  ...
  {
    id: 18,
    text: "In Niran’s poesis aether, you create a time artifact. How do you design it?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Provide guidance that aligns with their cultural values.", value: "F" },
    ],
    dimension: "TF",
  },
  {
    ...
    options: [
      { text: "Plan your role carefully, ensuring you respect their traditions.", value: "J" },
...
const Quiz = () => {
  ...
  const audioRef = useRef(new Audio('/ataraxia-quiz/assets/ataraxia-theme.mp3'));
  ...
  const downloadSigil = () => {
    ...
    if (resultElement) {
      html2canvas(resultElement).then((canvas) => {
        ...
        link.download = `ataraxia-sigil-${result.toLowerCase().replace(' ', '-')}.png`;
        link.click();
      });
    }
  };
  ...
  const shareOnInstagram = () => {
    alert('To share on Instagram, download your sigil and post it manually to your story or feed!');
  };
  ...
  const getSigilImage = (realm) => {
    try {
      return `/ataraxia-quiz/assets/sigil-${realm.toLowerCase().replace(' ', '-')}.png`;
    } catch (e) {
      console.error(`Sigil image for ${realm} not found`);
      return '/ataraxia-quiz/assets/sigil-sorin.png';
    }
  };
      ...
      <div className="text-center p-6 max-w-lg mx-auto cursor-quill">
        <div id="result-card">
          ...
          <img
            ...
            onError={(e) => (e.target.src = '/ataraxia-quiz/assets/sigil-sorin.png')}
          />
        </div>
